createValidationPackage <- function(modelFolder, 
  ...
  transportCohort(packageName = "EmcDementiaPredictionTable1",
...
transportCohort <- function(packageName = "EmcDementiaPredictionTable1",
                            outputDir = "./inst"){
...
createValidationJson <- function(modelFolder, 
  ...
  predictionAnalysisListFile <- system.file("settings",
                                            ...
                                            package = "EmcDementiaPredictionTable1")
