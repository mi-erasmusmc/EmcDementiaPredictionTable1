...
.createCohorts <- function(connection,
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "EmcDementiaPredictionTable1")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", cohortVariableSetting, package = "EmcDementiaPredictionTable1")
