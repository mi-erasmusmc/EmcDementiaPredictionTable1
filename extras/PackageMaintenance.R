...
#
# This file is part of EmcDementiaPredictionTable1
#
...
OhdsiRTools::checkUsagePackage("EmcDementiaPredictionTable1")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcDementiaPredictionTable1.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcDementiaPredictionTable1.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EmcDementiaPredictionTable1")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcDementiaPredictionTable1")
